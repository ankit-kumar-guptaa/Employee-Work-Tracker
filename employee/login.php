...
// Redirect if employee already logged in
...
if (isPostRequest()) {
    ...
    if (empty($username) || empty($password)) {
        ...
        // Attempt login
        if ($auth->loginEmployee($username, $password)) {
            $_SESSION['success'] = 'Welcome, ' . $_SESSION['employee_name'] . '!';
            redirect(BASE_URL . '/employee/dashboard.php');
        } else {
        ...
        <div class="col-lg-5 col-md-7">
            <div class="card shadow-lg border-0">
                <div class="card-header bg-success text-white text-center py-3">
                    <h4 class="mb-0"><i class="fas fa-user-tie me-2"></i> Employee Login</h4>
                </div>
